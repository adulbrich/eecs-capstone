...
COPY scripts/migrate.mjs scripts/promote-admin.mjs scripts/image-url-legacy.mjs scripts/import-legacy.mjs scripts/backfill-embeddings.mjs scripts/backfill-social-summaries.mjs ./scripts/
