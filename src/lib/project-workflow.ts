 ...
 * a status rather than name it: the staff stepper, the proposer's actions
 * block, the landing page's proposal path, and the badge's tooltip (#303 put
 * it there rather than a block of copy beside the badge). The wording is the
 * glossary's, in the third person, so the same sentence reads correctly to
 * staff, to the proposer and to any other viewer.
 */
