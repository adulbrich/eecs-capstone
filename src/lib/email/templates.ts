 ...
 *
 * The second paragraph is a safety warning, not filler. A code arriving
 * unbidden means somebody typed this address into the sign-in form, and the
 * one thing the owner must not do is pass it on.
 */
