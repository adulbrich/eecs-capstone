...
`project_assignments` tables exist from the original scaffold and have no UI or
server logic; removing them is open work, not a reason to build on them. The
